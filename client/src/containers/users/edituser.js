...
class AddUser extends React.Component {
  constructor (props, context) {
    ...
    this.state = {
      ...
      firstName: this.props.location.state.people_id.first_name,
      lastName: this.props.location.state.people_id.last_name,
      username: this.props.location.state.username,
      password: '',
      designation: this.props.location.state.people_id.designation,
      department: this.props.location.state.people_id.department,
      gender: this.props.location.state.people_id.gender,
      email: this.props.location.state.people_id.email,
      contact: this.props.location.state.people_id.contact,
      ext: 'none',
      officeHours: 'none',
      officeLocation: 'none',
      CNIC: this.props.location.state.people_id.CNIC,
      profilePic: 'none',
      university: this.props.location.state.university_id
    }
  ...
  editUser () {
    const data = {
      ...
      updatedBy: this.props.userdetails._id
    }
